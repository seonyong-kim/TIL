...
- Variable-length records arise in database systems in several ways:
  ...
  - Record types that allow repeating fields (arrays or multisets). <br>
  ![image](https://github.com/user-attachments/assets/c128f2d4-d753-4787-aac1-481a695e0952)
 • How to represent a variable-length record?– Two parts: an initial part with fixed length attributes, and data for variable 
length attributes– Variable length attributes represented by fixed size (offset, length), with 
